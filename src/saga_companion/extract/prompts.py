...
def _build_system_prompt() -> str:
    ...
    return "\n".join(
        (
            ...
            "If a person travels to a place, extract both a travel event and a travels_to relationship.",
            "If one person kills another, extract both a killing event and a kills relationship.",
