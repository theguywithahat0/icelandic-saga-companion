...
def _build_system_prompt(*, compact: bool) -> str:
    ...
    guidance_lines = [
            ...
            "Evidence quotes must be exact contiguous substrings copied from the passage: no ellipses, paraphrase, stitched spans, or invented punctuation.",
            ...
            "Prioritize high-signal relationships (parent-child, spouse, direct alliance/enmity/service/kill/wound) over exhaustive kinship expansion.",
            "Do not derive every possible sibling pair when parent-child relations already capture family structure.",
